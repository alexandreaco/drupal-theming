...
<head>
  ...
  <?php print $styles; ?>
  <?php print $scripts; ?>
  <link type="text/css" rel="stylesheet" href="http://fast.fonts.net/cssapi/990d7c24-9f38-4e5c-9151-175f97922d0e.css"/>
	<script type="text/javascript" src="http://fast.fonts.net/jsapi/990d7c24-9f38-4e5c-9151-175f97922d0e.js"></script>
  <link type="text/css" rel="stylesheet" media="all" href="<?php print base_path().path_to_theme().'/assets/fonts/script/stylesheet.css'; ?>" />
  <link type="text/css" rel="stylesheet" media="all" href="<?php print base_path().path_to_theme().'/assets/css/classic1aResponsive.css?'.time(); ?>" />
</head>
    ...
    <div id="header-inner" class="clear-block">
      ...
      <?php if ($logo || $site_name || $site_slogan): ?>
        <div id="logo-title">
          ...
          <?php if ($site_slogan): ?>
            <div id="site-slogan"><h2><?php print $site_slogan; ?></h2></div>
          <?php endif; ?>
...
<div class="clear">&nbsp;</div>
  ...
  <?php if ($closure_region): ?>
    <div id="closure-blocks" class="region region-closure"><div id="closure-blocks-inner"><?php print $closure_region; ?></div></div>
  <?php endif; ?>
