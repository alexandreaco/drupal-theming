 ...
 *   entirety and paste it here, changing the prefix from theme_ to classic1Responsive_.
 *   For example:
 *
 *     original: theme_breadcrumb()
 *     theme override: classic1Responsive_breadcrumb()
 *
 *   where classic1Responsive is the name of your sub-theme. For example, the
...
if (theme_get_setting('classic1Responsive_fixed')) {
 ...
 */
function classic1Responsive_theme(&$existing, $type, $theme, $path) {
...
function classic1Responsive_preprocess(&$vars, $hook) {
 ...
 */
/* -- Delete this line if you want to use this function
function classic1Responsive_preprocess_page(&$vars, $hook) {
  $vars['sample_variable'] = t('Lorem ipsum.');
}
// */
 ...
 */
/* -- Delete this line if you want to use this function
function classic1Responsive_preprocess_node(&$vars, $hook) {
  $vars['sample_variable'] = t('Lorem ipsum.');
}
// */
 ...
 */
/* -- Delete this line if you want to use this function
function classic1Responsive_preprocess_comment(&$vars, $hook) {
  $vars['sample_variable'] = t('Lorem ipsum.');
}
// */
 ...
 */
/* -- Delete this line if you want to use this function
function classic1Responsive_preprocess_block(&$vars, $hook) {
  $vars['sample_variable'] = t('Lorem ipsum.');
}
// */
...
function classic1Responsive_preprocess_page(&$vars, $hook) {
  ...
  $vars['terms'] = theme('item_list', $terms);
	...
	*/
	...
	function classic1Responsive_preprocess_search_theme_form(&$vars, $hook) {
...
function classic1Responsive_form_element($element, $value) {
...
function classic1Responsive_date_all_day_label() {
  return '<span></span>';
}